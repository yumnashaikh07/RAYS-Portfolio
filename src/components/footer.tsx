    ...
    <footer className="bg-[#1a1a1a] text-white px-5 py-3">
      <section className="grid grid-cols-1 md:flex md:justify-between md:gap-0 gap-3 items-center max-w-7xl mx-auto">
        ...
        <nav className="text-center md:mb-9 mb-0 md:text-left">
          ...
          <li><Link href="/#contact" className="hover:underline hover:text-[#d38bf9] hover:drop-shadow-[0_0_6px_#d38bf9]">Ask</Link></li>
          <li><Link href="/pricing" className="hover:underline hover:text-[#d38bf9] hover:drop-shadow-[0_0_6px_#d38bf9]">Pricing</Link></li>
