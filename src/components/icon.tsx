...
const ContactIcons = () => {
  return (
    <main><h1 className='text-3xl md:ml-16 mx-auto font-bold '>GET TO KNOW MORE</h1>
    <section className=" mt-3 p-5  text-black flex">
      ...
      <a
        ...
        aria-label="Phone"
      >
        <FaPhone size={31} className="md:ml-[77px] ml-11 text-blue-700 hover:text-white" />
      ...
      >
        <FaGithub size={37}  className="md:ml-12 ml-9" />
      </a>
      ...
      <div className="md:ml-12 ml-5 hover:text-[#1f4676]">Phone</div>
      <div className="md:ml-9 ml-5 hover:text-[#1f4676] ">Github</div>
      </section>
    </main>
  );
};
